...
int breakfastpr,lunchpr,dinnerpr;
int breakfastqty,lunchqty,dinnerqty;
void billpage();
void empjump();
void billjump();
void handlecust();
...
{
    system("CLS");
    gotoxy(40,1);cout<<"MEGA MESS II & CANTEEN SERVICE NIT TRICHY";
...
void store::price()
{
    ...
    cout<<endl<<"     ENTER PRICE OF BREAKFAST"<<endl;
    cout<<"     ";cin>>breakfastpr;cout<<endl;
    editprice<<"BREAKFAST"<<' '<<breakfastpr<<endl;
    cout<<"     ENTER PRICE OF LUNCH"<<endl;
    cout<<"     ";cin>>lunchpr;cout<<endl;
    editprice<<"LUNCH"<<' '<<lunchpr<<endl;
    cout<<"     ENTER PRICE OF DINNER"<<endl;
    cout<<"     ";cin>>dinnerpr;cout<<endl;
    editprice<<"SOFTDRINK"<<' '<<dinnerpr<<endl;;
    editprice.close();

    system("CLS");cout<<endl;
    gotoxy(40,0);cout<<"MEGA MESS II & CANTEEN SERVICE NIT TRICHY";
    gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
...
void store::quantity()
{
    ...
    cout<<endl<<"     ENTER QUANTITY OF BREAKFAST"<<endl;
    cout<<"     ";cin>>breakfastqty;cout<<endl;
    editqty<<"BREAKFAST"<<' '<<breakfastqty<<endl;
    cout<<"     ENTER QUANTITY OF LUNCH"<<endl;
    cout<<"     ";cin>>lunchqty;cout<<endl;
    editqty<<"LUNCH"<<' '<<lunchqty<<endl;
    cout<<"     ENTER QUANTITY OP DINNER"<<endl;
    cout<<"     ";cin>>dinnerqty;cout<<endl;
    editqty<<"SOFTDRINK"<<' '<<dinnerqty<<endl;
    editqty.close();
    system("CLS");
    gotoxy(40,1);cout<<"MEGA MESS II & CANTEEN SERVICE NIT TRICHY";
    gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
...
void store::viewinvt()
{
    ...
    gotoxy(40,1);cout<<"MEGA MESS II & CANTEEN SERVICE NIT TRICHY";
    gotoxy(40,2);cout<<"-----------------"<<endl<<endl;
    cout<<"     PRICE OF ITEMS IN MESS & CANTEEN"<<endl;
    cout<<"     ITEM - PRICE"<<endl;
    cout<<"     ------------"<<endl;
    ...
    vwpr.close();
    cout<<endl<<"     QUANTITY OF ITEMS IN MESS & CANTEEN"<<endl;
    cout<<"     ITEM - QUANTITY"<<endl;
    cout<<"     ---------------"<<endl;
...
void order::orderitem1()
{
    ...
    if(breakfastqty>=qty)
    {
        ...
        while(snackorder>>titem>>tqty)
        {
            ...
            {
                temp1<<"BREAKFAST"<<' '<<breakfastqty<<endl;
            }
        }
        temp1.close();
        snackorder.close();
...
void order::orderitem2()
{
    ...
    if(lunchqty>=qty)
    {
        lunchqty=lunchqty-qty;
        ofstream temp2("temp2.txt");
        ifstream lunchorder("QUANTITY.txt");
        while(lunchorder>>titem>>tqty)
        {
            if(titem!="LUNCH")
            {
...
void order::orderitem3()
{
    ...
    if(dinnerqty>=qty)
    {
        ...
        while(sdorder>>titem>>tqty)
        {
            ...
            {
                temp3<<"SOFTDRINK"<<' '<<dinnerqty<<endl;
            }
        }
        temp3.close();
        sdorder.close();
...
class login
{
  public:
      ...
      {
          system("CLS");
          gotoxy(40,1);cout<<"WELCOME TO MEGA MESS II & CANTEEN SERVICE NIT TRICHY";
          gotoxy(40,2);cout<<"----------------------------------------------------"<<endl<<endl;
          cout<<"     1. LOGIN"<<endl;
...
int main()
{
    system("MEGA MESS II & CANTEEN SERVICE NIT TRICHY MANAGEMENT SYSYTEM");
    system("color 03");
    login l;
    l.homepage();
    return 0;
